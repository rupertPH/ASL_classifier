...
#------------------------------
model_path = '../models/asl_classifier_dnn_model_v1b_no_ag.keras'
...
print("[INFO] Training finished. The best model was automatically saved in '../models/asl_classifier_dnn_model_v1b_no_ag.keras' during the process.")
print("[DONE]\n")
...
pdf_path = "../plots/training_report_dnn_v1b_no_ag.pdf"
